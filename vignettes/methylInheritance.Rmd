...
All those steps have been encoded in functions present in the 
...
## 1- treatment: a numeric vector denoting control (value = ) and test 
## (value = ) samples.
...
The observation and the permutation analysis could have been run together by 
