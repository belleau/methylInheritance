...
between consecutive generations (F1 and F2, F2 and F3, etc..). Those results
are considered the reference values.
...
```{r caseStudy03, warning=FALSE, message=FALSE, collapse=TRUE}
