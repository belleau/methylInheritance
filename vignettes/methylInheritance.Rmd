...
observationResult <- runObservationUsingMethylKitInfo(methylKitInfo = 
                        ...
                        minMethDiff = 10,   # Minimum difference in methylation to be considered DMS
                        qvalue = 0.01,
...
permutationResult <- runPermutationUsingMethylKitInfo(methylKitInfo = 
                        ...
                        nbrCores = 1,         # Number of cores used
                        nbrPermutations = 3,  # Should be much higher for a real analysis
                        minReads = 10,        # Minimum read coverage
                        minMethDiff = 10,     # Minimum difference in methylation to be considered DMS
                        qvalue = 0.01,
                        vSeed = 2101)         # Ensure reproducible results
...
1000 permutations (*nbrPermutation = 1000*). The results of those permutations 
will be used to generate the significant levels and the visual representations.
