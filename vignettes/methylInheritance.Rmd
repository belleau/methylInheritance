...
## F1 and F2 results for sites
##F1_and_F2 <- extractInfo(allResults = demoResults, type = "sites", inter = "i2", position = 1)
## F2 and F3 results for sites
##F2_and_F3 <- extractInfo(allResults = demoResults, type = "sites", inter = "i2", position = 1)
## F1 and F2 and F3 results for sites
##F2_and_F3 <- extractInfo(allResults = demoResults, type = "sites", inter = "i2", position = 1)
```
